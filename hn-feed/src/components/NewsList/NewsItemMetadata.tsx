...
const NewsItemMetadata: FC<NewsItemMetadataProps> = ({article, isComment}) => {
    ...
    return <Stack><Styles.SecondRowWrapper>
        ...
        {!!descendants && <Styles.SavedWrapper $saved={false} $isDark={false} onClick={() => setIsOpen(!isOpen)}><ArticleDetails>comments {descendants}</ArticleDetails></Styles.SavedWrapper>}
        <ArticleDetails>|</ArticleDetails>
